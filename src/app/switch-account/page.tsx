...
export default function SwitchAccountPage() {
    ...
    return (
        <div ref={containerRef} className="relative flex flex-col min-h-screen pb-28">
            <header className="pt-14 px-6 flex items-center justify-between shrink-0 sticky top-0 z-20">
                ...
                <a href="/notifications" onClick={(e) => {e.preventDefault(); handleRouteChange('/notifications')}} className="relative w-10 h-10 flex items-center justify-center rounded-full glass-panel text-white active:scale-95 transition-transform">
            ...
            <main className="px-6 pt-8 space-y-8">
                <section className="grid grid-cols-2 gap-4">
                    <a href="/teams/create" onClick={(e) => {e.preventDefault(); handleRouteChange('/teams/create')}} className="glass-panel p-6 rounded-[2.5rem] flex flex-col items-center justify-center gap-3 active:scale-95 transition-transform border-primary/20">
                    ...
                    <a href="/teams/join" onClick={(e) => {e.preventDefault(); handleRouteChange('/teams/join')}} className="glass-panel p-6 rounded-[2.5rem] flex flex-col items-center justify-center gap-3 active:scale-95 transition-transform">
