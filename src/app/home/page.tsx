...
export default async function HomePage() {
  ...
  return (
    <div className="relative flex flex-col pb-28 text-white mesh-background min-h-screen">
      ...
      <main className="px-6 pt-8 space-y-8">
        <section className="glass-panel p-6 rounded-3xl relative overflow-hidden">
          ...
          <p className="text-lavender-muted mt-1 opacity-90">
        ...
        <section>
          ...
          <div className="glass-panel p-6 rounded-3xl h-48 flex items-end justify-between gap-2">
            <div className="flex flex-col items-center gap-3 flex-1">
              ...
              <span className="text-[10px] text-lavender-muted uppercase font-bold">
                Mon
              </span>
            </div>
            <div className="flex flex-col items-center gap-3 flex-1">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button className="text-sm text-lavender-muted font-medium">
              View All
            </button>
          </div>
          <div className="space-y-3">
            ...
            <div className="glass-panel p-4 rounded-2xl flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center border border-white/10">
                <span className="material-symbols-outlined text-orange-400 leading-none">
                  api
                </span>
              </div>
              <div className="flex-1">
